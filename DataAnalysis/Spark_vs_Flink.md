...
Spark 和 Flink 是怎么做到这些的，它们之间又有那些异同，下面来具体看一下。
...
要理解Spark和Flink的引擎特点，需要先从数据模型开始。
...
![11](./images/Spark_vs_Flink/11.png)